...
function Card(props) {
  ...
  return (
    ...
    <div className=' col-start-auto row-start-auto col-span-1 row-span-1'>
      ...
      <div className="relative max-w-sm min-w-[340px] min-h-[280px] bg-white shadow-md rounded-md p-2 mx-1 my-3 cursor-pointer">
        <div className="overflow-x-hidden rounded-2xl relative">
          <Link to={`/detail/${props.id}`}>
            <img className="h-40 rounded-2xl w-full object-cover" src={props.image} />
          </Link>
        ...
        <div className="mt-4 pl-2 mb-2 flex justify-between">
          ...
          <div className="absolute right-2 bottom-[20px]  mb-1 mr-4 group cursor-pointer">
