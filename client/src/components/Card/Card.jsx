...
function Card(props) {
  ...
  }, [setIsFavorite, favorites, props.id, user?.id, user])
    ...
    <div className=' col-start-auto row-start-auto col-span-1 row-span-1'>
      ...
      <div className="relative max-w-sm min-w-[340px] min-h-[280px] bg-white shadow-md rounded-md p-2 mx-1 my-3">
        ...
        <div className="mt-4 pl-2 mb-2 flex justify-between">
          ...
          {showFavNotification && (
            <div className=" absolute bottom-0 right-0 p-2.5 bg-black bg-opacity-80 text-white text-sm font-bold rounded animate-fadeOutFav">
                You need to be logged to add favorites
            </div>
          )}
