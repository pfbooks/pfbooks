...
bookRouter.put('/update',async (req, res) => {
    ...
    const { id, title, author, price, image, genre, rating, stock, description, availability } = req.body;
    try {
        const enablementUser = ( await updateBookById(id, title, author, price, image, genre, rating, stock, description, availability) );
